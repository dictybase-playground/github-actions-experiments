...
try {
  ...
  const branch = payload.client_payload.github.slash_command.args.named.branch
  const commit = payload.client_payload.github.slash_command.args.named.commit
  const pullRequestID =
    payload.client_payload.github.slash_command.args.named.pr
  const sha = payload.client_payload.github.pull_request.head.sha
  const pullRequestNumber = payload.client_payload.github.pull_request.number
